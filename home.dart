...
class _HomeState extends State<Home> {
  ...
  void calculate() {
    double a = controllers.isNotEmpty ? double.tryParse(controllers[0].text) ?? 0 : 0;
    double b = controllers.length > 1 ? double.tryParse(controllers[1].text) ?? 0 : 0;
